...
async function addCountry(countryName, countryA2, countryEmissions){
    alert(countryName + countryA2 + countryEmissions)
    await axios.post('http://localhost:5000/adminNA', {data: {country: countryName, a2: countryA2, emissions: countryEmissions}})
